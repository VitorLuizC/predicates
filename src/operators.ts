type P<T extends boolean> = (value: any) => T;
...
export const OR: {
  ...
  (...ps: P<boolean>[]): P<boolean>;
} = (...ps: P<boolean>[]) => (value: any) => ps.some((p) => p(value));
